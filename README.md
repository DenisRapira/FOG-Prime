...
<img width="640" height="360" alt="image" src="https://github.com/user-attachments/assets/4d2183c4-0669-40f2-9c34-b6f87509f06a" />
## Возможности
...
UI не получает аргументы движка и не запускает shell-скрипты. Agent принимает только команды `status`, `start`, `stop` и `recheck`, проверяет runtime manifest и сам выбирает разрешённый профиль. Подробнее: [ARCHITECTURE.md](ARCHITECTURE.md).
